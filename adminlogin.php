...
body{
    ...
    background-image: url("http://localhost:8080/image2.jpeg");
...
<body>
    ...
    <div class="forms">
        <form action="login4admin.php" method="post">
        <h1 class="heading">LOGIN</h1>
        <input type="email"  placeholder="email" autocomplete="off" class="email" name="email"required pattern=".+gmail\.com">
